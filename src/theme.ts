...
// Type scale (MiniMax)
export const type = {
  heroDisplay: { size: 66, lh: 1.1, ls: -2, family: fontFamily.semibold },
  displayLg: { size: 50, lh: 1.1, ls: -1.5, family: fontFamily.semibold },
  headingLg: { size: 38, lh: 1.2, ls: -1, family: fontFamily.semibold },
  headingMd: { size: 30, lh: 1.25, ls: -0.5, family: fontFamily.semibold },
  headingSm: { size: 24, lh: 1.3, ls: -0.3, family: fontFamily.semibold },
  cardTitle: { size: 19, lh: 1.4, ls: -0.2, family: fontFamily.semibold },
  subtitle: { size: 17, lh: 1.5, ls: 0, family: fontFamily.medium },
  bodyMd: { size: 16, lh: 1.5, ls: 0, family: fontFamily.regular },
  bodyMdBold: { size: 16, lh: 1.5, ls: 0, family: fontFamily.bold },
  bodySm: { size: 14, lh: 1.5, ls: 0, family: fontFamily.regular },
  bodySmMed: { size: 14, lh: 1.5, ls: 0, family: fontFamily.medium },
  caption: { size: 15, lh: 1.5, ls: 0, family: fontFamily.regular },
  captionBold: { size: 15, lh: 1.4, ls: 0.3, family: fontFamily.semibold },
  micro: { size: 14, lh: 1.5, ls: 0.4, family: fontFamily.regular },
  microBold: { size: 14, lh: 1.4, ls: 1.5, family: fontFamily.semibold }, // eyebrow caps
  buttonMd: { size: 16, lh: 1.4, ls: 0, family: fontFamily.semibold },
};
...
export const CATEGORY_BRAND: Record<
  MainCategoryId,
  { bg: string; on: string }
> = {
...
export const CATEGORY_GRADIENT: Record<
  MainCategoryId,
